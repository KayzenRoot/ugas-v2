...
from .envelopes import FailureKind

@dataclass(frozen=True,slots=True)
class FailureRecord:
    id:str; project_id:str; trace_id:str; operation_ref:str; kind:FailureKind; retryable:bool; reason_code:str; evidence_ref:str; secret_free:bool=True
@dataclass(frozen=True,slots=True)
...
def validate_failure(record:FailureRecord)->None:
    ...
    non_retryable={FailureKind.POLICY_REJECTION,FailureKind.QUALITY_REJECTION,FailureKind.CAPABILITY_DENIED,FailureKind.INTEGRITY_FAILURE}
...
# hardware and failure without logging secrets or raw sensitive payloads. Retry policy consumes FailureKind.
